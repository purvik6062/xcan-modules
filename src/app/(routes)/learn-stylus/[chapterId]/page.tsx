...
import StylusContent from "@/components/stylus/StylusContent";
import StylusChapterCompletionModal from "@/components/stylus/StylusChapterCompletionModal";
...
export default function StylusChapterPage() {
  ...
  const chapter = stylusChapters.find((c) => c.id === chapterId);
          ...
          <div className="flex flex-1 items-center justify-center px-6">
            <div className="w-full max-w-md rounded-2xl border border-gray-800 bg-gray-900/80 p-8 text-center shadow-lg">
              ...
              <p className="text-gray-300">
                The Stylus chapter you&apos;re looking for doesn&apos;t exist.
              </p>
            </div>
          </div>
        </div>
  ...
  const currentChapterIndex = stylusChapters.findIndex(ch => ch.id === chapterId);
  const nextChapter = currentChapterIndex < stylusChapters.length - 1
          ...
          <div className="border-b border-gray-700 bg-gray-800 p-6">
            <div className="container mx-auto">
              <div className="mb-4 flex items-center justify-between">
                <div>
                  <h1 className="mb-2 bg-gradient-to-r from-blue-500 to-cyan-500 bg-clip-text text-3xl font-bold text-transparent">
                    {chapter.title}
                  </h1>
