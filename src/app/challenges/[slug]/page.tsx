  ...
  if (!challenge) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center p-4">
        <div className="max-w-xl w-full bg-gray-800 border border-gray-700 rounded-lg shadow-lg overflow-hidden">
          <div className=" bg-red-900/30 p-4 border-b  border-red-900/50">
            ...
            <h2 className="text-2xl font-bold text-center  text-red-200 mb-2">Challenge Not Found</h2>
          </div>
          <div className="p-6">
