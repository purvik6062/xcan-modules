...
export default function InteractiveLearningDashboard({
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg p-4 border border-yellow-200 dark:border-yellow-700">
            ...
            <div className="flex flex-wrap gap-2">
              {progressData.completed > 0 && (
                <span className="bg-yellow-200 dark:bg-yellow-800 text-yellow-800 dark:text-yellow-200 px-3 py-1 rounded-full text-xs font-medium">
                  First Steps
                </span>
              )}
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border sticky top-4  border-gray-200 dark:border-gray-700 overflow-hidden">
      {/* Tab Navigation */}
