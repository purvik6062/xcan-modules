              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {userData.achievements.map((achievement) => (
                    ...
                    >
                      <div className="flex-shrink-0 bg-yellow-100 dark:bg-yellow-900 p-3 rounded-full text-center">
                  ...
                  {/* Locked achievements */}
                  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 flex items-center opacity-50">
                    <div className="flex-shrink-0 bg-gray-200 dark:bg-gray-700 p-3 rounded-full text-center">
