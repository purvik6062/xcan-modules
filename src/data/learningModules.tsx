...
export const learningModules: LearningModule[] = [
  ...
  },
  {
    ...
    description:
      "Master cross-chain communication and bridge development. Learn to build interoperable blockchain solutions through engaging stories and hands-on practice.",
    icon: BookOpenIcon,
    level: "Intermediate to Advanced",
    duration: "3-4 weeks",
    challenges: 12,
