      ...
      {({ isAuthenticating, triggerAuth }) => (
        <div className="min-h-screen bg-gray-900">
          <div className="w-full p-4 sm:p-6 lg:p-4">
            ...
            {/* Side by Side Layout — wider quiz column on laptop */}
                ...
                <div className="flex h-full flex-col">
                  ...
                  <div className="flex flex-1 flex-col p-4 sm:p-6 lg:p-3">
                    <AnimatePresence mode="wait" initial={false}>
                      ...
                      >
                        {/* Question */}
                        <div className="mb-4 rounded-xl border border-gray-600 bg-gray-700 p-4 sm:mb-6 sm:p-5 lg:mb-3 lg:p-3">
                          ...
                          {question.options.map((option, index) => (
                            <button
                              ...
                              className={`w-full rounded-xl border-2 p-3 text-left transition-colors duration-150 hover:cursor-pointer sm:p-4 lg:p-2.5 ${isAnswered
                                ...
                                : "border-gray-600 bg-gray-800 text-gray-200 hover:border-pink-400 hover:bg-gray-700 active:scale-[0.99]"
                                }`}
                            >
                        ...
                        {isAnswered && (
                          ...
                          >
                            <button
                              ...
                              className={`flex w-full items-center justify-center rounded-lg bg-gradient-to-r from-blue-600 to-cyan-600 px-4 py-2.5 text-sm font-medium text-white transition-all duration-200 hover:cursor-pointer hover:from-blue-700 hover:to-cyan-700 sm:px-6 sm:py-3 sm:text-base lg:py-2 lg:text-xs ${isAuthenticating ? 'from-[#010335] to-blue-700 animate-pulse' : ''}`}
                            >
                              {isAuthenticating ? (
                                <>
