          ...
          <div className="lg:col-span-2 bg-gray-800 rounded-2xl border border-gray-700 overflow-hidden">
            <div className="h-full flex flex-col">
              <div className="p-8 flex-1 overflow-y-auto">
                <div className="prose prose-lg max-w-none prose-invert prose-headings:font-bold prose-h1:text-3xl prose-h2:text-2xl prose-h3:text-xl prose-p:text-base prose-p:leading-7 prose-p:mb-4 prose-strong:text-purple-300 prose-em:text-cyan-300">
                  <div className="text-gray-200 leading-relaxed font-sans space-y-6">
                    <ReactMarkdown
                      components={{
                        ...
                        h2: ({ children }) => <h2 className="text-2xl font-semibold text-purple-300 mb-4 mt-8">{children}</h2>,
                        ...
                        blockquote: ({ children }) => <blockquote className="border-l-4 border-purple-500 pl-4 italic text-gray-300 bg-gray-800/50 py-2 rounded-r my-4">{children}</blockquote>,
              ...
              <div className="bg-gradient-to-r from-purple-600 to-cyan-600 text-white p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-purple-100 text-sm">Answer all questions correctly to proceed</p>
                  </div>
                </div>
              </div>
                      ...
                      {question.options.map((option, index) => (
                        <motion.button
                          ...
                          className={`w-full text-left p-4 rounded-xl border-2 transition-all duration-200 ${isAnswered
                            ...
                            : "border-gray-600 hover:border-purple-400 hover:bg-gray-700 bg-gray-800 text-gray-200"
                            }`}
                    ...
                    {isAnswered && (
                      ...
                      >
                        <button
                          ...
                          className="w-full px-6 py-3 bg-gradient-to-r from-purple-600 to-cyan-600 text-white rounded-lg hover:from-purple-700 hover:to-cyan-700 transition-all duration-200 font-medium"
                        >
