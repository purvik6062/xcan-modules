...
export default function SectionNavigation({
  ...
  return (
    ...
    >
      ...
      <div
        className={`flex items-center p-4 border-b border-slate-600 ${isCollapsed ? "justify-center" : "justify-between"
          }`}
      >
        {!isCollapsed && (
          <motion.h3
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-grow min-w-0">
                        ...
                        <div className="flex items-center gap-2 text-xs">
                          <span
                            className={`capitalize px-2 py-1 rounded-full ${section.type === "theory"
              ...
              <div className="text-sm text-gray-400">
                ...
                <div className="w-full bg-slate-600 rounded-full h-2">
                  <div
                    ...
                    style={{
                      width: `${(completedSections.length /
              ...
              {sections.map((section, index) => {
                ...
                return (
                  <motion.button
                    ...
                    onClick={() => !isLocked && onSectionSelect(index)}
                    disabled={isLocked}
                    className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-200 relative group ${isCurrent
