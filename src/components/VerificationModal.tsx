  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
      <div className="bg-gray-900 rounded-lg shadow-lg max-w-md w-full p-6">
        ...
        {stagesComplete[2] && (
          <div
            className={`rounded-lg p-4 mb-6 ${allPassed ? "bg-green-900/30" : "bg-red-900/30"
              }`}
          >
            <div className="flex items-center">
              ...
              <div>
                <h4
                  className={`font-medium ${allPassed ? "text-green-400" : "text-red-400"
                    }`}
                >
        ...
        <div className="flex justify-end">
          <button
            onClick={onClose}
            className={`px-4 py-2 rounded ${stagesComplete[2]
